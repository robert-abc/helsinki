...
where <img src="https://render.githubusercontent.com/render/math?math=t \hat{\theta}_1"> are the weights of the generator network f after fitting to the degraded image (the subscript refers to the part one) and E is the loss function.  
